...
(function() {
	var INVALID_MSG = "잘못된 크론식",
        ...
        DAY_OF_WEEK = 5,
        YEAR = 6,
        ORDER = [MONTH, DAY_OF_MONTH, DAY_OF_WEEK, HOUR, MINUTE, SECOND],
        UNIT = ["초", "분", "시", "일", "월", "", "년"],
        UNIT_LIMIT = [59, 59, 23, 31, 12, 7, 2099],
        MONTH_MAP = {JAN:1,FEB:2,MAR:3,APR:4,MAY:5,JUN:6,JUL:7,AUG:8,SEP:9,OCT:10,NOV:11,DEC:12},
        DAY_MAP = {SUN:"일요일",MON:"월요일",TUE:"화요일",WED:"수요일",THU:"목요일",FRI:"금요일",SAT:"토요일",1:"일요일",2:"월요일",3:"화요일",4:"수요일",5:"목요일",6:"금요일",7:"토요일"},
        NTH_MAP = {1:"첫번째",2:"두번째",3:"세번째",4:"네번째",5:"다섯번째"};
